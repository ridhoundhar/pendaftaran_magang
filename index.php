        ...
        <div class="container">
            <div class="togle">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item"><a href="contac.php" data-title="Contac"><i class="fas fa-envelope"></i></a>
                    </li>
                    <li class="nav-item"><a href="login.php" data-title="Login"><i class="fas fa-sign-in-alt"></i></a>
                    </li>
                </ul>
            </div>
