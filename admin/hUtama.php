...
<head>
    ...
    <style>
        ...
        .bgg {
            background-image: linear-gradient(to top, rgba(0, 0, 0, 0.80), rgba(0, 0, 0, 0.848), rgba(0, 0, 0, 0)), url('../assets/image/bg.jpg');
            background-size: cover;
            margin: -10px;
...
<body>
    <div class="bgg">
        ...
        <div class="container">
            <div class="togle">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item"><a href="halamanadmin.php" data-title="Data"><i
                                class="fas fa-database"></i></a></li>
                    <li class="nav-item"><a href="halamanadmin.php#grafik" data-title="Grafik"><i
                                class="fas fa-chart-bar"></i></a></li>
                    <li class="nav-item"><a href="../login.php" data-title="Log out"><i
        ...
        <div class="content">
            ...
            <div class="daftar">
                <ul>
                    <li id="daftar"><a href="#">daftar</a></li>
